...
public class GoogleJwtIdentityTokenVerifier implements GoogleIdentityTokenVerifier {
    ...
    public GoogleUserInfo verify(String credential) {
        if (!properties.configured()) {
            throw new OAuthProviderNotConfiguredException("GOOGLE_CLIENT_ID is required for Google login.");
        }
        ...
        try {
            ...
            throw new InvalidGoogleTokenException("Invalid Google ID token.", exception);
        }
    }
